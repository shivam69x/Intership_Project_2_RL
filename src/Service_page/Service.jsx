        ...
        >
          <div className="max-w-screen-xl mx-auto text-center">
            ...
            <p className="mt-6 text-xs sm:text-sm md:text-base font-normal text-white max-w-md sm:max-w-xl md:max-w-3xl mx-auto leading-relaxed">
              Unlock smarter infrastructure, seamless operations, and
              future-proof growth with <br className="hidden sm:block" />
              <span>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 lg:gap-12">
              ...
              <div className="flex-1 w-full">
                ...
                <p className="text-white text-sm sm:text-base md:text-lg mt-4 sm:mt-6 leading-relaxed">
                  Take control of your cloud spending with advanced analytics
                  and real-time cost monitoring. Our comprehensive dashboard
                  provides actionable insights into resource utilization,
                  helping you optimize performance while reducing unnecessary
                  expenses.
                </p>
                <p className="text-white text-sm sm:text-base md:text-lg mt-4 leading-relaxed">
                  Track usage patterns, set budget alerts, and implement
                  automated cost-saving measures that align with your business
